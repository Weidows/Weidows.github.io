/*
 * @Author: Weidows
 * @Date: 2020-11-22 12:28:14
 * @LastEditors: Weidows
 * @LastEditTime: 2020-11-22 18:23:28
 * @FilePath: \Weidowsd:\Game\Demo\Github\Blog\source\skip_render\marketing_generator\main.js
 * @Description:
 */
...
function onload() {auto_grow(document.getElementById("result"));
}

function generate() {subject = document.getElementById("subject").value;
