 ...
 * @Date: 2021-02-08 18:59:13
 * @LastEditors: Weidows
 * @LastEditTime: 2022-04-20 23:42:18
...
public class Downloader1 extends Thread {
  ...
  public static void main(String[] args) {
    new Downloader1("https://www.helloimg.com/images/2022/07/01/ZM0SoX.png", "divider.png").start();
  }
}
```
...
public class Downloader implements Runnable {
  ...
  public static void main(String[] args) {
    new Thread(new Downloader("https://www.helloimg.com/images/2022/07/01/ZM0SoX.png",
        "./1.png")).start();
    new Thread(new Downloader("https://www.helloimg.com/images/2022/07/01/ZM0SoX.png",
        "./2.png")).start();
  }
...
public class Downloader2 implements Callable<Object> {
  ...
  public static void main(String[] args) {
    ...
    Future<Object> submit1 = ser
        .submit(new Downloader2("https://www.helloimg.com/images/2022/07/01/ZM0SoX.png",
            "./1.png"));
