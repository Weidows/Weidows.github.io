...
cover: https://www.helloimg.com/images/2022/02/27/GVP2cR.png
top_img:
---
 ...
 * @Author: Weidows
 * @LastEditors: Weidows
 * @LastEditTime: 2022-06-28 17:11:38
...
/d/Repos/Weidows-projects/Keeper
d:\Repos\Weidows-projects\Keeper\test.bat
d:\Repos\Weidows-projects\Keeper\
```
...
比如 jupyter-lab 运行的输出有时候会带有 XML 不支持的特殊符号 <sup id='cite_ref-1'>[\[1\]](#cite_note-1)</sup> (即使 echo $LANG 是 UTF-8)

![](https://www.helloimg.com/images/2022/06/28/Zlkb8Q.png)

解决办法就是通过 UTF-8 编码打开, 把这种符号全删掉保存 ([参见脚本](https://github.com/Weidows-projects/public-post/blob/main/notebook/convert.sh#L45))

<a>![分割线](https://fastly.jsdelivr.net/gh/Weidows/Images/img/divider.png)</a>

## 借物表

<a name='cite_note-1' href='#cite_ref-1'>[1]</a>: [Input is not proper UTF-8, indicate encoding !错误处理](https://blog.huati365.com/c4a41e416d7e30a8)
