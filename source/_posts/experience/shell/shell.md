...
- 可以用 basename, 用法 <sup id='cite_ref-1'>[\[1\]](#cite_note-1)</sup>
...
|      指令       |                                   作用                                    |
| :-------------: | :-----------------------------------------------------------------------: |
|   `ln -s A B`   | 创建 A 的快捷方式,名为 B <sup id='cite_ref-3'>[\[3\]](#cite_note-3)</sup> |
| `rm/unlink xxx` |       删除虚拟链接 <sup id='cite_ref-4'>[\[4\]](#cite_note-4)</sup>       |
...
命令是 `su xxx` <sup id='cite_ref-2'>[\[2\]](#cite_note-2)</sup>
...
<a name='cite_note-1' href='#cite_ref-1'>[1]</a>: [Linux 技巧：介绍从目录路径获取文件名和目录前缀的方法](https://segmentfault.com/a/1190000022722483)

<a name='cite_note-2' href='#cite_ref-2'>[2]</a>: [Linux 下如何切换用户](https://jingyan.baidu.com/article/a17d5285eb93ea8099c8f24d.html)
