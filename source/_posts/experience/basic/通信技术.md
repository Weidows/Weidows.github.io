...
cover: https://cdn.jsdelivr.net/gh/Weidows/Images/post/6PpSsXgtx1mwYF8.png
top_img:
---
 ...
 * @Author: Weidows
 * @LastEditors: Weidows
 * @LastEditTime: 2022-02-17 01:41:01
...
> <img src="https://cdn.jsdelivr.net/gh/Weidows/Images/post/7sGTmctk3JHZUOQ.png" alt="20220107015502" /> \
...
- 哈特莱首先提出使用对数 log 来描述信息
  ...
  操作原理就是 `通过概率间接量化信息`, 只不过哈特莱这里底数取得是 10, 下面香农改为了 2 (更适合计算机计算)
...
- 香农首先提出信息熵来度量信息,可以粗略解释为:
  ...
  $$
  信息熵: H=-k \sum_{i=1}^{n} p_{i} \log p_{i}
  $$
  ...
  > 每个字的使用频率概率, 出现场景, 上下文关联都会影响实际的信息熵 (比如文盲说话的信息熵不如学者高) \
...
> [“太极混一”——极化码原理及 5G 应用](https://res-www.zte.com.cn/mediares/magazine/publication/com_cn/article/201901/cn201901004.pdf)
...
- 当处理的码长(信道数)足够多时,好信道的互信息会无限逼近 1
