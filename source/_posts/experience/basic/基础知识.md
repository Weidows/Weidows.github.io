...
- 基础知识
  ...
  - 数据库
    ...
    - 通用
      ...
      - [读写分离](https://www.52pojie.cn/thread-1569242-1-1.html)
    - 课程
      - [数据库考试试题及答案](https://www.docin.com/p-1564094016.html)
      - [子查询](https://www.cnblogs.com/Soprano/p/10659101.html)
    - Neo4j
      - [让所有程序员都能学懂的 Neo4j 数据库教程，B 站史上最实用的 Neo4j 数据库入门到实战学习教程](https://www.bilibili.com/video/BV1EB4y1a7Sf?p=15)
      - [图数据库 Neo4j 的部署、数据导入和简单使用](https://www.zmonster.me/2019/04/30/neo4j-introduction.html#org02654fb)
  - 算法-数学
    - 傅里叶变换
  ...
  - 论文
    - [如何将 CNKI 论文信息转换成你想要的参考文献格式](https://cloud.tencent.com/developer/news/231960)
      - 关键时候挺好用的功能
    - [word 操作技巧：有关脚注和尾注的使用方法](https://zhuanlan.zhihu.com/p/54344547)
...
[单片机时钟周期、机器周期、指令周期与总线周期](https://www.jdzj.com/diangong/article/2018-2-3/95275-1.htm)
...
![](https://www.helloimg.com/images/2022/03/23/R1Uw16.jpg)
...
> 放弃吧。“并行就是未来”的说法就是一片浮云。 <sup id='cite_ref-4'>[\[4\]](#cite_note-4)</sup>

![](https://www.helloimg.com/images/2022/03/23/R1Ujyo.jpg)
...
- 显卡: 3d 计算加速卡,图形处理需要做大量线性代数向量运算(3 维模型的坐标转换和投影), 取决于向量运算的数学性质, 其可以通过并行运算来加速处理,区别如下:
  ...
  GPU 的运算独立, 简单看来核心越多算的越快,这种计算方式叫`向量化计算`
...
![](https://www.helloimg.com/images/2022/03/23/R1gRMt.jpg)
