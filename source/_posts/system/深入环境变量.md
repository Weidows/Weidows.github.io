...
cover: https://cdn.jsdelivr.net/gh/Weidows/Images@master/hpp/蓝红色春运简洁春节中文微信公众号封面.jpg
top_img:
---
 ...
 * @Author: Weidows
 * @LastEditors: Weidows
 * @LastEditTime: 2021-03-07 16:45:20
...
- 这是华为的 DevEco,安装时会询问是否添加至环境变量,那,添加到环境变量有什么用呢?
  <img src="https://cdn.jsdelivr.net/gh/Weidows/Images@master/hpp/20210307160552.png" alt="20210307160552" />
...
- 比如我安装了 VScode,并把 vscode 安装目录它添加环境变量,我们打开一个终端
  ...
  <img src="https://cdn.jsdelivr.net/gh/Weidows/Images@master/hpp/20210307161139.png" alt="20210307161139" />
