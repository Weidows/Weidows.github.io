...
- 前端
  - HTML/CSS
    ...
    - Markdown
      - 这个没有什么特效课程,需要循序渐进的使用 markdown 记笔记
      - 把一些关键词用熟悉,渐渐地文章就变得好起来了
      - markdown 这种归档式,目录式以及层级递进式的笔记方式,能很好地锻炼表达思维
      - 而且对学习效果有显著提升.
  - JavaScript
    - 进阶
...
- Python
  ...
  - 文章
    - [👍Anaconda-Python-水漂浅探池深浅.](../python/anaconda)
  - 工具
...
- 泛域
  ...
  - 自信
    - [上班 4 年，现在却只会调工具包，AI 程序员崩溃了](https://blog.csdn.net/m0_46163918/article/details/114883501?utm_source=app&app_version=4.5.4)
      - 我发现我好想也有点文中提到的“冒名顶替综合征”,文中也有我认为很好的解决办法:
        ...
        - 保持学习者心态
    - 随着年龄的增大,越发发现自信的重要性.
    - 初中时就被体育老师鼓动,直到现在仍然感觉带有自信头衔的人有独特的美丽.
    - 当然,自信不是自负,是合理的外向+阳光+乐观的态度,在社交,职场和情感方面都有一定作用.
  - 编码习惯
  ...
  - 文档编写
    ...
    - [一个挺像样的项目文档: 软件项目开发文档](https://wenku.baidu.com/view/1e0708f41611cc7931b765ce05087632311274cf.html)
  - 代理
